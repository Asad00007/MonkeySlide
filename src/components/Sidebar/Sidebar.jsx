...
const Sidebar = () => {
  ...
  return (
    <div
      className="fixed 2xl:sticky left-0 top-[83px] z-40 overflow-hidden"
      style={{ height: "calc(100vh - 83px)" }}
    >
      <div
        className="absolute -right-3 top-3 p-2 px-3 rounded-full border border-[#4a556557] z-50  bg-[#18181b] cursor-pointer text-white"
        onClick={() => setSideBar(!sideBar)}
      >
        <FaChevronLeft
          className={`text-[14px] -translate-x-[3px] ${
      ...
      <div
        ...
        } bg-[#0d0c0e] relative  text-white py-14 px-3 h-full flex flex-col items-center border-r-2 border-[#4a556557] transition-all duration-300 ease-in-out `}
      >
        <div className="absolute top-0 w-[50px] h-[50px] bg-white rounded-full shadow-[0px_0px_50px_rbga(255,255,255,0.1)] blur-3xl"></div>
        <div className="absolute top-1/2 right-0 w-[70px] h-[90px] bg-yellow-300 rounded-full shadow-[0px_0px_50px_rbga(255,255,255,1)] blur-3xl"></div>
        {sideBar ? (
